...
# Form implementation generated from reading ui file 'interfeic6.0.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.NameSchool = QtWidgets.QLineEdit(self.tab_3)
        self.NameSchool.setEnabled(False)
        self.NameSchool.setObjectName("NameSchool")
        self.verticalLayout_7.addWidget(self.NameSchool)
        ...
        self.emblema = QtWidgets.QLabel(self.tab)
        self.emblema.setGeometry(QtCore.QRect(110, 20, 320, 124))
        self.emblema.setObjectName("emblema")
        ...
        self.emblema_yandex = QtWidgets.QLabel(self.tab)
        self.emblema_yandex.setGeometry(QtCore.QRect(750, 520, 175, 75))
        self.emblema_yandex.setObjectName("emblema_yandex")
        self.label3 = QtWidgets.QLabel(self.tab)
        self.label3.setGeometry(QtCore.QRect(670, 500, 221, 61))
        ...
        self.one_lesson = QtWidgets.QLineEdit(self.layoutWidget)
        self.one_lesson.setObjectName("one_lesson")
        self.horizontalLayout_12.addWidget(self.one_lesson)
        ...
        self.two_lesson = QtWidgets.QLineEdit(self.layoutWidget)
        self.two_lesson.setObjectName("two_lesson")
        self.horizontalLayout_3.addWidget(self.two_lesson)
        ...
        self.three_lesson = QtWidgets.QLineEdit(self.layoutWidget)
        self.three_lesson.setObjectName("three_lesson")
        self.horizontalLayout_14.addWidget(self.three_lesson)
        ...
        self.fout_lesson = QtWidgets.QLineEdit(self.layoutWidget)
        self.fout_lesson.setObjectName("fout_lesson")
        self.horizontalLayout_5.addWidget(self.fout_lesson)
        ...
        self.five_lesson = QtWidgets.QLineEdit(self.layoutWidget)
        self.five_lesson.setObjectName("five_lesson")
        self.horizontalLayout_13.addWidget(self.five_lesson)
        ...
        self.six_lesson = QtWidgets.QLineEdit(self.layoutWidget)
        self.six_lesson.setObjectName("six_lesson")
        self.horizontalLayout_7.addWidget(self.six_lesson)
        ...
        self.seven_lesson = QtWidgets.QLineEdit(self.layoutWidget)
        self.seven_lesson.setObjectName("seven_lesson")
        self.horizontalLayout_15.addWidget(self.seven_lesson)
        ...
        self.eight_lesson = QtWidgets.QLineEdit(self.layoutWidget)
        self.eight_lesson.setObjectName("eight_lesson")
        self.horizontalLayout_8.addWidget(self.eight_lesson)
        self.verticalLayout_5.addLayout(self.horizontalLayout_8)
        self.save_settings = QtWidgets.QPushButton(self.layoutWidget)
        self.save_settings.setObjectName("save_settings")
        self.verticalLayout_5.addWidget(self.save_settings)
        ...
        self.list_of_tabs.setCurrentIndex(5)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.emblema.setText(_translate("MainWindow", "Картинка"))
        self.label_2.setText(_translate("MainWindow", "Название школы:"))
        self.emblema_yandex.setText(_translate("MainWindow", "Эмблема Яндекс"))
        self.label3.setText(_translate("MainWindow", "Проект подготовил:\n"
"ученик 2 курса \n"
"Очилов Тимур"))
        ...
        self.save_settings.setText(_translate("MainWindow", "Сохранить изменения Графика уроков"))
